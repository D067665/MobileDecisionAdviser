sap.ui.define([
	...
	"thirdPartyIntegration": {"importance":{"key":"medium","weight":"2"},"selectionOptions":{"key":"notSelected","resultInfluence":["0","0","0"]}}
				...
				var aDecisionPercentageClientTechnology = [0,0,0]
				
				;
				var aDecisionPercentageDataSync = {
					"dataSync" : [0,0,0]
				};
				var aDecisionPercentageOperationsCenter = {
					"operationsCenter" : [0,0,0]
				};
			...
			var oDialog = new sap.m.Dialog("dialog", {
				...
				beginButton: new Button({
					...
					//	oModel.setProperty("/clientTechnology", aClientTechnology);
							...
							savedProjectsModel.setProperty(viewBindingPath + "/decisionPercentage", aDecisionPercentageDataSync);
							...
							savedProjectsModel.setProperty(viewBindingPath + "/decisionPercentage", aDecisionPercentageOperationsCenter);
